...
from fake_stake.base_test import ROICOIN_FakeStakeTest

class zROIwrappedSerialsTest(ROICOIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zROIs..." % DENOM_TO_USE)
