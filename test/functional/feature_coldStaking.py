...
from test_framework.roicoin_node import ROIcoinTestNode
...
class ROICOIN_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(ROIcoinTestNode())
