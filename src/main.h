...
inline int64_t GetMasterNodeCollateral(int nHeight){
    if (nHeight <= 250 && nHeight > 0) {
        return 10000;
    } else if (nHeight <= 10000 && nHeight > 250) {
        return 10000;
        ...
        return 35000;
    } else if (nHeight <= 80000 && nHeight > 40000) {
        return 50000;
    } else if (nHeight <= 400000 && nHeight > 80000) {
        return 100000;
    } else if (nHeight <= 500000 && nHeight > 400000) {
        return 250000;
    } else if (nHeight <= 800000 && nHeight > 500000) {
        return 300000;
    } else if (nHeight <= 900000 && nHeight > 800000) {
        return 400000;
    } else if (nHeight <= 2000000 && nHeight > 900000) {
        return 500000;
