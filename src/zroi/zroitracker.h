...
#ifndef ROICOIN_ZROITRACKER_H
#define ROICOIN_ZROITRACKER_H
...
public:
    CzROITracker(std::string strWalletFile);
    ~CzROITracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzROIWallet* zROIWallet = NULL);
