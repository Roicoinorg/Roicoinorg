 ...
 * ROICOIN system. There are three: the main network on which people trade goods
...
public:
    ...
    int ROIcoinBadBlockTime() const { return nROIcoinBadBlockTime; }
    int ROIcoinBadBlocknBits() const { return nROIcoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nROIcoinBadBlockTime;
    unsigned int nROIcoinBadBlocknBits;
