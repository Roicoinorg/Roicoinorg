...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Roi Coin roicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  roicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded roicoin transaction") + "\n" +
                               "  roicoin-tx [options] -create [commands]   " + _("Create hex-encoded roicoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded roicoin transaction
