...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "ROICOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ROICOIN features */
        {"roicoin", "listmasternodes", &listmasternodes, true, true, false},
        {"roicoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"roicoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"roicoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"roicoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"roicoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"roicoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"roicoin", "masternodedebug", &masternodedebug, true, true, false},
        {"roicoin", "startmasternode", &startmasternode, true, true, false},
        {"roicoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"roicoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"roicoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"roicoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"roicoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"roicoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"roicoin", "preparebudget", &preparebudget, true, true, false},
        {"roicoin", "submitbudget", &submitbudget, true, true, false},
        {"roicoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"roicoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"roicoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"roicoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"roicoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"roicoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"roicoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"roicoin", "checkbudgets", &checkbudgets, true, true, false},
        {"roicoin", "mnsync", &mnsync, true, true, false},
        {"roicoin", "spork", &spork, true, true, false},
        {"roicoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> roicoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6551/\n";
}
