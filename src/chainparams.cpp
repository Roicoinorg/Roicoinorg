...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x000009c930190067512897e85c130473f1af961c9a9b5980918404066df661b4"))
	

	;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1657204238, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("042930dd761c7819914d251e0d7db0a4fec481a0d9d70bfdcb20669bf5c323ef032c9b970464f954f066c9636b4fccb5e637ffe5422736f1dce5bb5648857965ec");
        nDefaultPort = 6552;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // ROICOIN starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 250;
        nROIcoinBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nROIcoinBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        ...
        nEnforceNewSporkKey = 1612263600; //!> Sporks signed after , 02 02 2021 12:00:00 GMT must use the new spork key
        nRejectOldSporkKey = 1612260000; //!> Fully reject old spork key after ,02 02 2021 11:00:00  GMT
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Welcome to the new passive roi coin blockchain";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("041e1a4e8679b762ca2970e4022a9f3b1d2167779d6b39273f9ffedac269145d70216d2a944e0a8e2f4db5dcf62e0c24892560d9668152fa0c26aed634459f9d87") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 1;
        genesis.nTime = 1657204238;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 7471692;

        hashGenesisBlock = genesis.GetHash();

	assert(hashGenesisBlock == uint256("0x000009c930190067512897e85c130473f1af961c9a9b5980918404066df661b4"));
        assert(genesis.hashMerkleRoot == uint256("0xa9a06236fcb15676c78e6fa3d8cd2b81ca0da4ef393d1ea5a85865fcbb5098fe"));

        vSeeds.push_back(CDNSSeedData("206.188.197.104", "206.188.197.104"));
        vSeeds.push_back(CDNSSeedData("45.61.139.41", "45.61.139.41"));		
        vSeeds.push_back(CDNSSeedData("45.61.136.20", "45.61.136.20"));
        vSeeds.push_back(CDNSSeedData("node1.roicoin.org", "node1.roicoin.org"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 60);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 24);
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 61);     // starting with 'M'
        ...
        strSporkPubKey = "04f865a6412b18f50751b7fab816db4847c9a6f42a9788af20bb0ebe28c8fce25ae18471a2220535ec83546285fce6bbf93943f6417831bb462b2a4843c7d5e7a6";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zroi to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nROIcoinBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nROIcoinBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet roicoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet roicoin script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet roicoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet roicoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet roicoin BIP44 coin type is '1' (All coin's testnet default)
        ...
        strObfuscationPoolDummyAddress = "roifGRkekRyDRNeJiLtYVEbvhXrNbmox";
