...
/** Utility functions used by the ROICOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render ROICOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZroi = false);
...
// Parse "roicoin:" URI into recipient object, return true on successful parsing
