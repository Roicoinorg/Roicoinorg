...
#ifndef ROICOIN_QT_WALLETMODEL_H
#define ROICOIN_QT_WALLETMODEL_H
...
/** Interface to ROICOIN wallet from Qt view code. */
...
#endif // ROICOIN_QT_WALLETMODEL_H
