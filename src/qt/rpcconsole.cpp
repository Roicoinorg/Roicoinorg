                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzROIPathCustom = GetArg("-zroibackuppath", "");
    ...
    if(!strzROIPathCustom.empty()) {
        ui->wallet_customzroibackuppath->setText(QString::fromStdString(strzROIPathCustom));
        ui->wallet_customzroibackuppath_label->setVisible(true);
        ui->wallet_customzroibackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzROIPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ROICOIN RPC console.") + "<br>" +
