...
#ifndef ROICOIN_CORE_NEW_GUI_ROICOINGUI_H
#define ROICOIN_CORE_NEW_GUI_ROICOINGUI_H
...
/**
  ROICOIN GUI main class. This class represents the main window of the ROICOIN UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ROICOINGUI : public QMainWindow
{
    Q_OBJECT
...
#endif //ROICOIN_CORE_NEW_GUI_ROICOINGUI_H
