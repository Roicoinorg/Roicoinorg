...
#include "qt/roicoin/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(ROICOINGUI* parent);
    ~SendWidget();
...
private slots:
    void onROISelected(bool _isROI);
    void onSendClicked();
...
private:
    ...
    bool sendZroi(QList<SendCoinsRecipient> recipients);
