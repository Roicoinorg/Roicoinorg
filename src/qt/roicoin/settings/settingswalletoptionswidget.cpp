...
#include "qt/roicoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/roicoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(ROICOINGUI* _window, QWidget *parent) :
