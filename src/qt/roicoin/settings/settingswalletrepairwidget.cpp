...
#include "qt/roicoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/roicoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ROICOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ROICOINGUI::handleRestart()
