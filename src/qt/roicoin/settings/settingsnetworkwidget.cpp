...
#include "qt/roicoin/settings/settingsnetworkwidget.h"
#include "qt/roicoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/roicoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ROICOINGUI* _window, QWidget *parent) :
