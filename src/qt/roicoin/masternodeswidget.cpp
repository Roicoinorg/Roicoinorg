...
#include "qt/roicoin/forms/ui_masternodeswidget.h"
#include "qt/roicoin/qtutils.h"
#include "qt/roicoin/mnrow.h"
#include "qt/roicoin/mninfodialog.h"

#include "qt/roicoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(ROICOINGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:6552 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (COIN * GetMasterNodeCollateral(chainActive.Height()))){
