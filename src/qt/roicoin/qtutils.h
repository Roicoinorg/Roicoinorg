...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, ROICOINGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, ROICOINGUI *gui, double posX = 3);
