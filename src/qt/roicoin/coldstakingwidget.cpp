...
#include "qt/roicoin/coldstakingwidget.h"
#include "qt/roicoin/forms/ui_coldstakingwidget.h"
#include "qt/roicoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/roicoin/requestdialog.h"
#include "qt/roicoin/tooltipmenu.h"
#include "qt/roicoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(ROICOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your ROIs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept ROI delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select ROI outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 ROI" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
