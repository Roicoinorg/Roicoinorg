...
#include "config/roicoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalRoi = 0;
    qint64 totalZroi = 0;
    QList<qreal> valuesRoi;
    QList<qreal> valueszRoi;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(ROICOINGUI* _window);
    ~DashboardWidget();
