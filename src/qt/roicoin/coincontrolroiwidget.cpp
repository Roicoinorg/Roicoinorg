...
#include "qt/roicoin/coincontrolroiwidget.h"
#include "qt/roicoin/forms/ui_coincontrolroiwidget.h"

CoinControlRoiWidget::CoinControlRoiWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlRoiWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select ROI Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("ROI");
    ...
    ui->labelValueAfter->setText("0.00 ROI");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 ROI");
    ui->labelValueFee->setText("0.00 ROI");
...
CoinControlRoiWidget::~CoinControlRoiWidget()
{
    delete ui;
}
