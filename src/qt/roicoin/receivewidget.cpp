...
#include "qt/roicoin/forms/ui_receivewidget.h"
...
#include "qt/roicoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(ROICOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive ROI."));
