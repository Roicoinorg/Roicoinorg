...
#include "qt/roicoin/furabstractlistitemdelegate.h"
#include "qt/roicoin/txviewholder.h"
#include "qt/roicoin/tooltipmenu.h"
#include "qt/roicoin/sendmultirow.h"
#include "qt/roicoin/coldstakingmodel.h"
#include "qt/roicoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(ROICOINGUI* parent);
    ~ColdStakingWidget();
