...
#ifndef ROICOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define ROICOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //ROICOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
