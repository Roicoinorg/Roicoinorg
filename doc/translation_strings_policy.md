...
This document provides guidelines for internationalization of the Roi Coin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to ROICOIN network</numerusform>
            <numerusform>%n active connections to ROICOIN network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `roicoin_en.ts` remains unchanged.
