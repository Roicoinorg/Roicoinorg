...
The script [extract-osx-sdk.sh](https://github.com/ROIcoin/roicoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
roicoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ROIcoin/roicoin/blob/master/doc/README_osx.md) for troubleshooting tips.