...
1. Clone the Roi Coin source code:

        git clone https://github.com/ROIcoin/roicoin
        cd roicoin
...
Roi Coin is now available at `./src/roicoind`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/ROICOIN"

    touch "/Users/${USER}/Library/Application Support/ROICOIN/roicoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/ROICOIN/roicoin.conf"

The first time you run roicoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/roicoind -daemon # Starts the roicoin daemon.
    ./src/roicoin-cli --help # Outputs a list of command-line options.
    ./src/roicoin-cli help # Outputs a list of RPC commands when the daemon is running.
