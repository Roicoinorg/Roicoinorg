Contributing to Roi Coin
============================

The Roi Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ROIcoin/roicoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Roi Coin project, and is not to be
confused with overall ROICOIN Network Protocol consensus changes.

Whether a pull request is merged into Roi Coin rests with the project merge
...
Patches that change ROICOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the ROICOIN consensus, it must have been
...
The project leader is the release manager for each Roi Coin release.
