...
RESOURCES += src/qt/roicoin.qrc src/qt/roicoin_locale.qrc

TRANSLATIONS += src/qt/locale/roicoin_bg.ts \
                src/qt/locale/roicoin_de.ts \
                src/qt/locale/roicoin_en.ts \
                src/qt/locale/roicoin_es.ts \
                src/qt/locale/roicoin_fi.ts \
                src/qt/locale/roicoin_fr.ts \
                src/qt/locale/roicoin_it.ts \
                src/qt/locale/roicoin_ja.ts \
                src/qt/locale/roicoin_pl.ts \
                src/qt/locale/roicoin_pt.ts \
                src/qt/locale/roicoin_ru.ts \
                src/qt/locale/roicoin_sk.ts \
                src/qt/locale/roicoin_sv.ts \
                src/qt/locale/roicoin_vi.ts \
                src/qt/locale/roicoin_zh_CN.ts \
                src/qt/locale/roicoin_zh_TW.ts
